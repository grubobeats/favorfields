// Sparkleh javascript Starts Here 
jQuery.fn.sparkleh = function( options ) {
  return this.each( function(k,v) {
    var jQuerythis = jQuery(v);
...
function Sparkle( jQueryparent, options ) {
  this.options = options;
  this.init( jQueryparent );
}

Sparkle.prototype = {
  "init" : function( jQueryparent ) {
    var _this = this;
    this.jQuerycanvas = 
    jQuery("<canvas>")
